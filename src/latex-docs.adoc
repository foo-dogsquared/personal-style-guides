...
If you decide to use admonition blocks, I've already created link:./latex/docs-admonition-blocks.sty[a custom package] for it. 
...
For an example, you can see link:./latex/docs-admonition-blocks.sty[a admonition blocks custom package] to know how it's done. 
...
You can see link:./latex/docs-config.sty[an example of the main style]. 
...
You can find it at link:./latex/docs-ifrootdocument.sty[my LaTeX templates]. 
